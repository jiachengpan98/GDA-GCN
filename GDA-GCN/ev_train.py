...
from PAE import PAE
from opt import *
from EV_GCN import EV_GCN, snowball
...
if __name__ == '__main__':
    ...
    for fold in range(n_folds):
        ...
        # print(edgenet_input.shape)

        # aij = np.zeros([532, 532])
        # for i in range(532):
        ...
        # model =snowball( node_ftr.shape[1], 9, 200, 2, 0.19567, nn.Tanh())
        ...
        # aij = torch.tensor(aij, dtype=torch.float32).to(opt.device)
        ...
        def train():
            ...
            for epoch in range(opt.num_iter):
                ...
                with torch.set_grad_enabled(True):
                    ...
                    F.normalize(node_logits)
                    # print("node+",node_logits)
