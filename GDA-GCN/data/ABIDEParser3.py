...
root_folder = '/media/pjc'
# data_folder = os.path.join(root_folder, 'MDD_pcp/mdd_data')
phenotype = os.path.join(root_folder, 'REST-meta-MDD_Clinical.csv')
data_folder = '/media/pjc/mdd_data_ho2'
data_folder2 = '/media/pjc/mdd_data'
...
def get_ids(num_subjects=None):
    ...
    subject_IDs = np.genfromtxt(os.path.join(data_folder, 'Clinical_MDDsubject_IDs_work2.txt'), dtype=str)
...
def get_static_affinity_adj(features, pd_dict):
    ...
    # pd_affinity = (pd_affinity - pd_affinity.mean(axis=0)) / pd_affinity.std(axis=0) 'SITE_ID'
    # print(pd_affinity)
